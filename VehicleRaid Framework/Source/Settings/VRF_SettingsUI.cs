...
namespace VehicleRaidFramework
{
    ...
    public static class VRF_SettingsUI
    {
        ...
        {
            float totalContentH = 920f;
            Rect scrollArea = new Rect(rect.x, rect.y, rect.width, rect.height);
            Rect viewRect = new Rect(0f, 0f, scrollArea.width - 20f, totalContentH);
            ...
            Text.Font = GameFont.Medium;
            {
                ...
                Widgets.Label(new Rect(0f, y, titleW, 32f), title);
                Rect titleTip = new Rect(titleW + 2f, y + 7f, 22f, 22f);
                GUI.color = Color.yellow;
                Text.Font = GameFont.Small;
            ...
            if (Widgets.ButtonText(new Rect(0f, y, 260f, 28f), btnLabel))
            ...
            Widgets.Label(new Rect(0f, y, contentW, 22f), "VRF_ThrusterConfig_Title".Translate());
            GUI.color = Color.white;
            y += 24f;
            if (Widgets.ButtonText(new Rect(0f, y, 280f, 28f), "VRF_ThrusterConfig_OpenButton".Translate()))
            {
                Find.WindowStack.Add(new VehicleMapFramework.Dialog_VRF_ThrusterConfig());
            }
            y += 34f;

            Widgets.DrawLineHorizontal(0f, y, contentW * 0.6f);
            y += 14f;

            // Probabilidad de vehículos en raids (NUEVA OPCIÓN)
            Text.Font = GameFont.Medium;
            {
            ...
            Text.Font = GameFont.Medium;
            Widgets.Label(new Rect(0f, y, contentW, 32f), "VRF_Settings_VehiclePointsFractionTitle".Translate());
            y += 36f;
            Text.Font = GameFont.Small;
            ...
            Text.Font = GameFont.Medium;
            Widgets.Label(new Rect(0f, y, contentW, 32f), "VRF_Settings_AutoFillAmmoFractionTitle".Translate());
            y += 36f;
            Text.Font = GameFont.Small;
            ...
            DrawConfigField(0f, ref y, labelW, fieldW, rowH, "VRF_Settings_WeightHP".Translate(), ref VRF_Mod.Settings.WeightHP, "WeightHP");
            DrawConfigField(0f, ref y, labelW, fieldW, rowH, "VRF_Settings_WeightArmor".Translate(), ref VRF_Mod.Settings.WeightArmor, "WeightArmor");
            DrawConfigField(0f, ref y, labelW, fieldW, rowH, "VRF_Settings_WeightDPS".Translate(), ref VRF_Mod.Settings.WeightDPS, "WeightDPS");
            DrawConfigField(0f, ref y, labelW, fieldW, rowH, "VRF_Settings_WeightRange".Translate(), ref VRF_Mod.Settings.WeightRange, "WeightRange");
            DrawConfigField(0f, ref y, labelW, fieldW, rowH, "VRF_Settings_WeightSpeed".Translate(), ref VRF_Mod.Settings.WeightSpeed, "WeightSpeed");
            DrawConfigField(0f, ref y, labelW, fieldW, rowH, "VRF_Settings_WeightDrivers".Translate(), ref VRF_Mod.Settings.WeightDrivers, "WeightDrivers");
            DrawConfigField(0f, ref y, labelW, fieldW, rowH, "VRF_Settings_WeightGunners".Translate(), ref VRF_Mod.Settings.WeightGunners, "WeightGunners");
            DrawConfigField(0f, ref y, labelW, fieldW, rowH, "VRF_Settings_WeightPassengers".Translate(), ref VRF_Mod.Settings.WeightPassengers, "WeightPassengers");
            DrawConfigField(0f, ref y, labelW, fieldW, rowH, "VRF_Settings_WeightSize".Translate(), ref VRF_Mod.Settings.WeightSize, "WeightSize");
            DrawConfigField(0f, ref y, labelW, fieldW, rowH, "VRF_Settings_AirMultiplier".Translate(), ref VRF_Mod.Settings.AirMultiplier, "AirMultiplier");
            {
                Rect airTip = new Rect(labelW + fieldW + 6f, y - rowH + (rowH - 18f) * 0.5f, 18f, 18f);
                GUI.color = Color.yellow;
            ...
            Widgets.CheckboxLabeled(new Rect(0f, y, 400f, 24f), "VRF_Settings_AutoFillTransport".Translate(), ref VRF_Mod.Settings.AutoFillTransportVehicles);
            ...
            Widgets.CheckboxLabeled(new Rect(0f, y, 400f, 24f), "VRF_Settings_AutoFillSiegeDrop".Translate(), ref VRF_Mod.Settings.AutoFillSiegeDropVehicles);
            if (prevSiegeDrop != VRF_Mod.Settings.AutoFillSiegeDropVehicles) VRF_Mod.Instance.WriteSettings();
            if (Mouse.IsOver(new Rect(0f, y, 400f, 24f)))
                TooltipHandler.TipRegion(new Rect(0f, y, 400f, 24f), "VRF_Settings_AutoFillSiegeDropDesc".Translate());
            y += 30f;

            bool prevDropOnly = VRF_Mod.Settings.SiegeDropOnlyOnDropRaids;
            Widgets.CheckboxLabeled(new Rect(0f, y, 400f, 24f), "VRF_Settings_SiegeDropOnly".Translate(), ref VRF_Mod.Settings.SiegeDropOnlyOnDropRaids);
            if (prevDropOnly != VRF_Mod.Settings.SiegeDropOnlyOnDropRaids) VRF_Mod.Instance.WriteSettings();
            if (Mouse.IsOver(new Rect(0f, y, 400f, 24f)))
                TooltipHandler.TipRegion(new Rect(0f, y, 400f, 24f), "VRF_Settings_SiegeDropOnlyDesc".Translate());
            y += 30f;
            ...
            Text.Font = GameFont.Medium;
            Widgets.Label(new Rect(0f, y, contentW, 30f), "Developer / Debug");
            y += 34f;
            Text.Font = GameFont.Small;

            bool prevVerbose = VRF_Mod.Settings.VerboseAILogging;
            Widgets.CheckboxLabeled(new Rect(0f, y, 500f, 24f),
                "Verbose NPC vehicle AI logging",
                ref VRF_Mod.Settings.VerboseAILogging);
            if (Mouse.IsOver(new Rect(0f, y, 500f, 24f)))
                TooltipHandler.TipRegion(new Rect(0f, y, 500f, 24f),
            ...
            if (Widgets.ButtonText(new Rect(0f, y, 120f, 30f), "VRF_Settings_Save".Translate()))
            {
                VRF_Mod.Instance.WriteSettings();
                Messages.Message("VRF_Settings_Saved".Translate(), MessageTypeDefOf.PositiveEvent, false);
            }

            if (Widgets.ButtonText(new Rect(130f, y, 120f, 30f), "VRF_Settings_Reset".Translate()))
            {
        ...
        private static VRF_NaturalRaidVehicleEntry CloneVehicleEntry(VRF_NaturalRaidVehicleEntry src)
        {
            ...
            {
                enabled = src.enabled,
                combatPowerOverride = src.combatPowerOverride,
                minRaidPoints = src.minRaidPoints,
                maxRaidPoints = src.maxRaidPoints,
                fuelPercent = src.fuelPercent,
                helicopterMode = src.helicopterMode,
                helicopterMoveSpeed = src.helicopterMoveSpeed,
                airVehicleType = src.airVehicleType,
                forceSpawn = src.forceSpawn,
                isSiegeDrop = src.isSiegeDrop,
                allowDropPod = src.allowDropPod,
