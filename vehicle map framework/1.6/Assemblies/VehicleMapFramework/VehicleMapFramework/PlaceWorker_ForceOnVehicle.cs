...
// Type: VehicleMapFramework.PlaceWorker_ForceOnVehicle
...
public class PlaceWorker_ForceOnVehicle : PlaceWorker
{
    ...
    Thing thing = null)
  {
    ...
    return gravEngineNewTemp != null && ((IEnumerable<IntVec3>) (object) source).All<IntVec3>(new Func<IntVec3, bool>(gravEngineNewTemp.ValidSubstructureAt)) ? AcceptanceReport.op_Implicit(true) : AcceptanceReport.op_Implicit(Translator.Translate("VMF_ForceOnVehicle"));
  }
}
