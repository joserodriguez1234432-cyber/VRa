...
// Type: VehicleMapFramework.PlaceWorker_ForceOnVehicleMapEdgeReverse
...
public class PlaceWorker_ForceOnVehicleMapEdgeReverse : PlaceWorker_ForceOnVehicleMapEdge
{
    ...
    Thing thing = null)
  {
    ...
    return ((IEnumerable<IntVec3>) (object) GenAdj.OccupiedRect(loc, rot, checkingDef.Size)).Select<IntVec3, IntVec3>((Func<IntVec3, IntVec3>) (cell => IntVec3.op_Addition(cell, ((Rot4) ref rot).FacingCell))).Any<IntVec3>((Func<IntVec3, bool>) (facingCell =>
    {
