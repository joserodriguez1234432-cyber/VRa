...
// Type: VehicleMapFramework.VMF_HarmonyPatches.Patch_MapTemperature_SeasonalTemp
...
public static class Patch_MapTemperature_SeasonalTemp
{
  public static bool Prefix(Map ___map, ref float __result)
  {
    ...
    else if (PlanetTile.op_Inequality(((Thing) vehicle).Tile, PlanetTile.op_Implicit(-1)))
      __result = Find.World.tileTemperatures.GetSeasonalTemp(((Thing) vehicle).Tile);
    return false;
  }
}
