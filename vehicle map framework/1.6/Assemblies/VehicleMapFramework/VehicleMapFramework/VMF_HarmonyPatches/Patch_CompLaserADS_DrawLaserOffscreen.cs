...
// Type: VehicleMapFramework.VMF_HarmonyPatches.Patch_CompLaserADS_DrawLaserOffscreen
...
public static class Patch_CompLaserADS_DrawLaserOffscreen
{
  public static IEnumerable<CodeInstruction> Transpiler(IEnumerable<CodeInstruction> instructions)
  {
    ...
    {
      PatchHelper.get_CallInstruction(MethodInfoCache.CachedMethodInfo.m_BaseMap_Map)
