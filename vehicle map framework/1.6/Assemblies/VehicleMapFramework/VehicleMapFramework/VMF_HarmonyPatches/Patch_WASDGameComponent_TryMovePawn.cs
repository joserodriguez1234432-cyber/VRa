...
// Type: VehicleMapFramework.VMF_HarmonyPatches.Patch_WASDGameComponent_TryMovePawn
...
public static class Patch_WASDGameComponent_TryMovePawn
{
  ...
  {
    FieldInfo f_lasPos3 = AccessTools.Field("wasdedPawn.WASDGameComponent:lasPos3");
    ...
    }).Repeat((Action<CodeMatcher>) (c => c.MatchStartBackwards(new CodeMatch[1]
    {
      CodeMatch.LoadsField(f_lasPos3, false)
    }).InsertAfterAndAdvance(new CodeInstruction[2]
    {
