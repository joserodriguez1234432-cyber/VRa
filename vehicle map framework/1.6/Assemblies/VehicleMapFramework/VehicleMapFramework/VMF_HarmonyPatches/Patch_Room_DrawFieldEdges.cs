...
// Type: VehicleMapFramework.VMF_HarmonyPatches.Patch_Room_DrawFieldEdges
...
[HarmonyPatch(typeof (Room), "DrawFieldEdges")]
...
public static class Patch_Room_DrawFieldEdges
{
  public static IEnumerable<CodeInstruction> Transpiler(IEnumerable<CodeInstruction> instructions)
  {
    ...
    }).InsertAndAdvance(new CodeInstruction[2]
    {
      ...
      PatchHelper.get_CallvirtInstruction(AccessTools.PropertyGetter(typeof (Room), "Map"))
