...
// Type: VehicleMapFramework.VMF_HarmonyPatches.Patch_Building_Turret_OrderAttack
...
public static class Patch_Building_Turret_OrderAttack
{
  ...
  {
    instructions = (IEnumerable<CodeInstruction>) instructions.MethodReplacer(MethodInfoCache.CachedMethodInfo.g_Thing_Position, MethodInfoCache.CachedMethodInfo.m_PositionOnBaseMap);
