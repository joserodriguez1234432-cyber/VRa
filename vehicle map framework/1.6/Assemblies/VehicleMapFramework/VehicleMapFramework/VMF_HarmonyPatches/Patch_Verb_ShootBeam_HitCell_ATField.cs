...
// Type: VehicleMapFramework.VMF_HarmonyPatches.Patch_Verb_ShootBeam_HitCell_ATField
...
public static class Patch_Verb_ShootBeam_HitCell_ATField
{
  ...
  public static bool Prefix(Verb_ShootBeam __instance, IntVec3 cell, IntVec3 sourceCell)
  {
    ...
    for (int index = 0; index < readOnlySpan.Length; ++index)
    {
      ...
      {
        if (!Patch_Verb_ShootBeam_HitCell_ATField.PatchPrefix(__instance, cell, sourceCell))
          return false;
      }
    }
    return true;
